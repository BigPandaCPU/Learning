...
QT_MOC_LITERAL(1, 9, 8), // "isClosed"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 1) // "i"

    },
    "MyWidget\0isClosed\0\0i"
};
...
void MyWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->isClosed((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyWidget::isClosed)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void MyWidget::isClosed(int _t1)
{
